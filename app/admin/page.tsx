    ...
    <ProtectedRoute adminOnly>
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 border-b border-gray-100 pb-4">
          <div>
            ...
            <div className="flex gap-2 p-1 bg-gray-100/50 rounded-xl w-fit border border-gray-200/50">
              ...
              <button
                ...
                className={`px-6 py-2 rounded-lg text-sm font-bold transition-all flex items-center gap-2 ${activeTab === "live"
          ...
          {/* New Product Button (Only for Inventory Tab) */}
          {activeTab === "inventory" && (
            <button
              onClick={() => {
              ...
              className={`px-6 py-3 rounded-2xl font-bold transition-all ${showForm && !editingProduct
