        ...
        <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 text-gray-600">
                ...
                <span>Ciudad del Viento, Punto Fijo, Falcón, Venezuela.</span>
              </div>
              <div className="flex items-center gap-4 text-gray-600">
                <div className="w-10 h-10 rounded-full bg-purple-50 flex items-center justify-center text-purple-600 flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex items-center gap-4 text-gray-600">
                ...
                <span>KinderStorePFpf@gmail.com</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-600">
              ...
              <p>Horaria de live: Se anuncia via WhatsApp</p>
            </div>
          </div>
        </div>
